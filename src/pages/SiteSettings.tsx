...
export function SiteSettings() {
  ...
  const addSocialLink = () => {
    ...
    setData({
      ...data,
      socialLinks: [...data.socialLinks, { platform: 'Twitter', label: 'Twitter', url: 'https://twitter.com/' }],
    });
  };
  ...
  if (!data) return <div style={{ padding: '2rem', color: 'var(--cms-text-soft)' }}>Loading settings...</div>;
  ...
  return (
    <div>
      <div className="cms-page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h1>Site Settings</h1>
          <p>Global site configuration, metadata, branding, and social profiles</p>
        </div>
      ...
      <div className="cms-card">
        <div className="cms-card-header">
          <span className="cms-card-title">General Information</span>
        </div>
        <div className="cms-form-row">
          ...
          <div className="cms-form-group">
            <label className="cms-label">Canonical Site URL</label>
      ...
      <div className="cms-card" style={{ marginTop: '1.5rem' }}>
        <div className="cms-card-header">
          <span className="cms-card-title">Social Profiles</span>
        ...
        {data.socialLinks.map((social, idx) => (
          <div key={idx} className="cms-array-item" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div style={{ flex: 1 }} className="cms-form-row">
              ...
              <input className="cms-input" placeholder="URL" value={social.url} onChange={e => updateSocialLink(idx, 'url', e.target.value)} />
            </div>
